...
const projects = [
...

  {
    ...
    technologies: ["React", "FastAPI", "Python", "SQLite", "Gemini AI"],
    github: "https://github.com/mohan2005-code",
    demo: "#",
  },

  {
    ...
    github: "https://github.com/mohan2005-code/cloud-kitchen",
...

  {
    ...
    technologies: ["React", "JavaScript", "HTML", "CSS"],
    github: "https://github.com/mohan2005-code/apple-adventure",
...

  {
    ...
    github: "https://github.com/mohan2005-code/DEMO",
    demo: "#",
  },
];
                ...
                <div className="flex gap-4">
                  ...
                  {project.demo !== "#" ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 flex justify-center items-center gap-2 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 transition duration-300"
                    >
                      <FaExternalLinkAlt />
                      Live Demo
                    </a>
                  ) : (
                    <span className="flex-1 flex justify-center items-center gap-2 py-3 rounded-xl bg-gray-700 text-gray-400 cursor-not-allowed">
                      <FaExternalLinkAlt />
                      Live Demo
                    </span>
                  )}
